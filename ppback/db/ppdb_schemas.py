...
class AgentPatch(Base):
    ...
    id:int = Column(Integer, primary_key=True, index=True)
    profile_name:str = Column(String, )
    subprofile_name:str = Column(String, )
...
class ItemAssignement(Base):
    ...
    action:str = Column(String, ) # drop, add, produced
...
class UserInfo(Base):
    ...
    salted_password:str = Column(String, )
